                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Upload.jsp">
                                    ...
                                    <span class="menu-title"><b style="color: #33D4FF">Upload File</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="Files.jsp">
                                    <img src="images/arrow.png" width="200px" alt="" style="color: #33D4FF">
                                    <span class="menu-title"><b style="color: #33D4FF">My Files</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="sharing_request.jsp">
                                    <img src="images/arrow.png" width="200px" alt="">
                                    <span class="menu-title"><b style="color: #33D4FF">Sharing Request</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="Key_Request.jsp">
                                    <img src="images/arrow.png" width="200px" alt="">
                                    <span class="menu-title"><b style="color: #33D4FF">Key Request</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="Transaction.jsp">
                                    <img src="images/arrow.png" width="200px" alt="">
                                    <span class="menu-title"><b style="color: #33D4FF">File Transaction</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <table id="customers">
                                           <thead>
                                            ...
                                            <form action="key_approve.jsp" method="get">
                                                <input  hidden="" name="fid" value="<%=rs.getString("fid")%>" type="text" >
                                                <input   hidden=""  name="mail" value="<%=rs.getString("mmail")%>" type="text" >
                                                <input hidden=""  name="time"  value="<%=rs.getString("time")%>" type="text" >
                                                <td class="center"><input style="background-color: transparent; border: none; color: #000" name="filename" value="<%=rs.getString("filename")%>" type="text" ></td>
                                                    <td class="center"><input style="background-color: transparent; border: none; color: #000"  name="mname" value="<%=rs.getString("mname")%>"  type="text" ></td>
                                                    <td class="center"><input style="background-color: transparent; border: none; color: #000"  value="<%=rs.getString("time")%>" type="text" ></td>
                                                    <td class="center"><%=rs.getString("statuss")%> </td>
                                                    <td><i><button type="submit" class="btn btn-success btn-circle fa fa-check-circle fa-2x" style="color: white ; width: 40px; height: 40px"></button></i></td>
                                            </form>
                                            <td><i><a href="key_reject.jsp?mid=<%=rs.getString("mid")%>&email=<%=rs.getString("mmail")%>&time=<%=rs.getString("time")%>" class="btn btn-danger btn-circle fa fa-trash fa-2x " style="color: white; width: 40px; height: 40px"></a></i></td>
                                                </tr>
                                            </tbody>
                                            <%                                        }
                                                } catch (Exception ex) {
