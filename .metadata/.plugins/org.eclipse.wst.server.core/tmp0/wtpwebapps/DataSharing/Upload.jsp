           ...
           <div class="container-fluid">
                <div class="row row-offcanvas row-offcanvas-right" style=" background: white">
                    ...
                    <div class="content-wrapper" style="background: white">
                            ...
                            <center><h1><strong>File upload</strong></h1></center>
                            <form action="upload" method="post" enctype="multipart/form-data">
  <div class="form-group">
  </div>
                                <div class="form-group file-area">
        <label for="images">Drag and Drop or Select The File<span></span></label>
        <div style="background-color: #8360c3; color: black;  /* fallback for old browsers */
background: -webkit-linear-gradient(to bottom, #2ebf91, #8360c3);  /* Chrome 10-25, Safari 5.1-6 */
background: linear-gradient(to bottom, #2ebf91, #8360c3); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */">
    <input type="file" name="data" id="images" required="required" />
    <div class="file-dummy">
      <div class="success">Hi  your files are selected. Click Upload</div>
