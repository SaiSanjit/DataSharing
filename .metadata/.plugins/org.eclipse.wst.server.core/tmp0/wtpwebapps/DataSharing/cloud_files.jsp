            ...
            <div class="container-fluid">                
                <div class="row row-offcanvas row-offcanvas-right" style="background: white">                    
                        ...
                        <ul class="nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="cloud_files.jsp">
                                    <img src="images/arrow.png" width="200px" alt="" style="color: white">
                                    <span class="menu-title"><b style="color: #33D4FF">Cloud Files</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="member_request.jsp">
                                    <img src="images/arrow.png" width="200px" alt="">
                                    <span class="menu-title"><b style="color: #33D4FF">Data Request</b></span>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="content-wrapper" style="background: white">
                        <center><h1  style="font: bold"><strong>Cloud Files</strong></h1></center>
                                    <style>
#customers {
...
<table id="customers">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            try {
                                                ResultSet rs = st.executeQuery("Select * from dofiles");
                                                while (rs.next()) {
                                        %>
                                        <tr>
