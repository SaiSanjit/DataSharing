            ...
            <div class="container-fluid">                
                <div class="row row-offcanvas row-offcanvas-right" style="background: white">                    
                    ...
                    <div class="content-wrapper" style="background: white">
                        <center><h1  style="font: bold"><strong>Download History</strong></h1></center>
                         <style>
                                #customers {
                            ...
                            <table id="customers">
                                           <thead>
                                            ...
                                            <%
                                                ...
                                                try {
                                                    ResultSet rs = st.executeQuery("Select * from download where mid ='" +mid+ "'");
                                                    while (rs.next()) {
                                            %>
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><%=rs.getString("doname")%> </td>
                                                </tr>
                                            </tbody>
                                            <%                                        }
                                                } catch (Exception ex) {
