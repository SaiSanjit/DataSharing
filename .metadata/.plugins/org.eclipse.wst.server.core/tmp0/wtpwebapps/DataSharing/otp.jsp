            ...
            <div class="container-fluid">
                <div class="row row-offcanvas row-offcanvas-right" style="background: white">
                    ...
                    <div class="content-wrapper" style="background: white">
                        ...
                        <%            }
                        %>
                        <center><h3 style="color: black"><b>Data Owner OTP Verification</b></h3>
                            <br>
                            <form action="otp1.jsp" method="get" >
                                <label style="color: black">Enter Your otp</label>
                                <div class="form-group" style="width: 400px" >
                                    <input type="password" name="votp" required="" class="form-control p_input"autocomplete="off" >
                                </div>
                                <br>
                                <br>
                                <div class="text-center" style="width: 200px" >
                                    <button type="submit" class="btn btn-primary btn-block enter-btn" style="background-image: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"><a>Verify</a></button>
                                    <br><br>
                                </div>
                            </form>
                        </center>
