            ...
            <div class="container-fluid">
                <div class="row row-offcanvas row-offcanvas-right" style=" background: white">
                    ...
                    <div class="content-wrapper" style="background: white">
                        <section>
                            <!--for demo wrap-->
                            <center><h1  style="font: bold"><strong>My Uploaded Files</strong></h1></center>
                                    <style>
#customers {
...
<table id="customers">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            try {
                                                ResultSet rs = st.executeQuery("Select * from dofiles where DO_Id ='" + doid + "' AND grp='"+grp+"'");
                                                while (rs.next()) {
                                        %>
                                        <tr>
                                            ...
                                            <td class="center"><%=rs.getString("Dkey")%></td>
                                            <td class="center"><%=rs.getString("grp")%></td>
                                            <td><i><a href="delete.jsp?id=<%=rs.getString("id")%>"  class="btn btn-danger" style="color: white">&nbsp;<i class="fa fa-trash-o"></i></a></i></td>
                                            <%                                        }
                                            } catch (Exception ex) {
                                                ex.printStackTrace();
                                            }
