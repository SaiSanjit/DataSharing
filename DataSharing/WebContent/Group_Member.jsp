...
<html lang="en">
    ...
    <%
        ...
        <script>alert('Your Acount not Verified  ');</script>  
        <%}
        %>
    <style>
        ...
        .form-container {
            max-width: 300px;
            padding: 10px;
            background-color: #8360c3;  /* fallback for old browsers */
...
background: linear-gradient(to bottom, #2ebf91, #8360c3); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
        ...
        .form-container input[type=text],.form-container select, .form-container input[type=password] {
            width: 100%;
            padding: 15px;
            margin: 5px 0 22px 0;
            border: none;
            ...
            <div class="container-fluid">
                <div class="row row-offcanvas row-offcanvas-right" style="background: white">
                    ...
                    <div class="content-wrapper" style="background: white">
                        <center><h3 style="color: black"><b>Group Member Login</b></h3>
                            <br>
                            <form action="member_login.jsp" method="get" >
                        ...
                        <div class="form-popup" id="myForm">
                            <form action="member_reg.jsp" method="get" class="form-container">
                                <h1>Member Registration</h1>

                                <label for="email"><b>Name</b></label>
                                <input type="text" placeholder="Enter Name" name="name" autocomplete="off" required>

                                <label for="email"><b>Select Group</b></label>
