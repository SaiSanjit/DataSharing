...
>
            ...
            <div class="container-fluid">                
                <div class="row row-offcanvas row-offcanvas-right" style="background: white">                    
                    ...
                    <script>alert('File Not Found Please Try different keyword');</script>  
                    <%}
                    %>
                    <%
                    ...
                    <div class="content-wrapper" style="background: white">
                        <center><h3 style="color: black"><b>Decrypt Shared Data</b></h3>
                            <br>
                            <form action="Download" method="post" >
                                <input hidden="" name="fid" type="text" value="<%=fid%>">
                                <label style="color: black">File Name</label>
                                <div class="form-group" style="width: 400px" >
                                    <input type="text" name="fname"value="<%=fname%>" required="" class="form-control p_input" autocomplete="off" >
                                </div>
                                <%
                                ...
                                %>
                                <label style="color: black">Encrypted Data</label>
                                <div class="form-group" style="width: 400px" >
                                    <textarea style="height: 100px" class="form-control p_input"autocomplete="off" ><%=rs.getString("Enc_Con")%></textarea>
                                </div>
                                <label style="color: black">Enter Decryption Key</label>
                                <div class="form-group" style="width: 400px" >
                                    <input type="text" name="dkey" required="" class="form-control p_input"autocomplete="off" >
                                </div>
                                <br>
                                <br>
                                <div class="text-center" style="width: 200px" >
                                    <button type="submit" class="btn btn-primary btn-block enter-btn" style="background-image: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"><a>Decrypt & View</a></button>
                                    <br><br>
                                </div>
                            </form>
                        </center>
