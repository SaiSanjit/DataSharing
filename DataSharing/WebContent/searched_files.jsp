            ...
            <div class="container-fluid">                
                <div class="row row-offcanvas row-offcanvas-right" style="background: white">                    
                    ...
                    <div class="content-wrapper" style="background: white">
                        <section>
                            <!--for demo wrap-->
                            <center><h1  style="font: bold"><strong>Searched Files</strong></h1></center>
                            <style>
                                #customers {
                            ...
                            <table id="customers">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        String keyword = request.getQueryString();
                                    ...
                                    <tr>
                                        ...
                                        <td><i><a href="filerequest.jsp?fid=<%=rs.getString("id")%>&open=<%=rs.getString("Dkey")%>"  class="btn btn-danger" style="color: white">&nbsp;Download</a></i></td>
                                    </tr>
                                </tbody>
                                <%
                                            }
