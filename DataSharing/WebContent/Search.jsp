...
<%
        ...
        %>
                    <!-- partial -->
                        <center><h3 style="color: black"><b>Search Files in Cloud</b></h3>
                            <br>
                            <form action="search1.jsp" method="get" >
                                <label style="color: black">Enter keyword</label>
                                <div class="form-group" style="width: 400px" >
                                    <input type="text" name="keyword" required="" class="form-control p_input"autocomplete="off" >
                                </div>
                                <br>
                                <br>
                                <div class="text-center" style="width: 200px" >
                                    <button type="submit" class="btn btn-primary btn-block enter-btn" style="background-image: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"><a>Search</a></button>
                                    <br><br>
                                </div>
                            </form>
                        </center>
