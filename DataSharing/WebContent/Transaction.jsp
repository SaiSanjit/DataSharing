...
<html lang="en">
    ...
    <head>
        ...
        <title>Dynamic Mechanism to Preserve Shared Data from Unauthorized Access in Cloud using Time Stamp</title>
...
>
                    ...
                    <h3 class="center-aligned-table" style="color: white">Dynamic Mechanism to Preserve Shared Data from Unauthorized Access in Cloud using Time Stamp</h3>
            ...
            <div class="container-fluid">
                <div class="row row-offcanvas row-offcanvas-right" style=" background: white">
                    ...
                    <div class="content-wrapper" style="background: white">               
                        <center><h1  style="font: bold"><strong>File Transaction</strong></h1></center>
                         <style>
                                #customers {
                                           ...
                                           <thead>
                                            ...
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center"><%=rs.getString("mid")%> </td>
                                                </tr>
                                            </tbody>
                                            <%                                        }
                                                } catch (Exception ex) {
