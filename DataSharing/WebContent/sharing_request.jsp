            ...
            <div class="container-fluid">
                <div class="row row-offcanvas row-offcanvas-right" style=" background: white">
                    ...
                    <div class="content-wrapper" style="background: white">
                        <section>
                            <!--for demo wrap-->
                            <center><h1  style="font: bold"><strong>Data Sharing Group Request</strong></h1></center>
                            <style>
#customers {
...
<table id="customers">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            try {
                                                ResultSet rs = st.executeQuery("Select * from member where grp ='" + grp + "'");
                                                while (rs.next()) {
                                        %>
                                        <tr>
                                            ...
                                            <td><i><a href="approve.jsp?mid=<%=rs.getString("id")%>&email=<%=rs.getString("Email")%>"  class="btn btn-success" style="color: white">&nbsp;Approve</i></a></i></td>
                                            <td><i><a href="reject.jsp?mid=<%=rs.getString("id")%>&email=<%=rs.getString("Email")%>"   class="btn btn-danger" style="color: white">&nbsp;Reject</i></a></i></td>
                                            <%                                        }
                                            } catch (Exception ex) {
                                                ex.printStackTrace();
                                            }
